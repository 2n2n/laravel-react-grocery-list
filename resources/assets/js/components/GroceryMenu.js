...
class GroceryMenu extends Component {
    ...
    componentDidMount() {
        ...
        menuIngredientService
            .fetchMenuIngredient(this.props.menu.id)
            .then(ingredients => {
                this.setState({
    ...
    onAddIngredient(e) {
        ...
        menuIngredientService
            .addMenuIngredient(this.props.menu.id, this.state.ingredientName)
            .then(data => {
                menuIngredientService
                    .fetchMenuIngredient(this.props.menu.id)
                    .then(data => {
    ...
    render() {
        const renderMenuName = this.state.menuNameModify ? (
            ...
            <h5 className="card-title" onClick={this.onToggleMenuName}>
                {name}
            </h5>
        );
        ...
        const renderIngredients = this.state.ingredients.map(ingredient => (
            <Ingredient
                ...
                onAddIngredientToGroceryList={this.onAddIngredientToGroceryList.bind(
                    this
                )}
                onRemoveIngredientFromGroceryMenu={
                    this.onRemoveIngredientFromGroceryMenu
                }
            />
        ));
        ...
        const renderAddNewIngredient = this.state.addIngredient ? (
            <AddIngredient
                ...
                onChangeIngredientName={val =>
                    this.setState({ ingredientName: val })
                }
            />
        ) : (
            ""
                ...
                <div className="card" style={{ width: "18rem", marginBottom: "20px" }}>
                    <div className="card-body">
                        <h5 className="card-title">
                            <i class="fas fa-utensils"></i> {this.props.menu.name}
                        </h5>
                    </div>
                        ...
                        <div className="row">
                            <div className="col-md-12">
                                ...
                                <button
                                    ...
                                    onClick={this.onDeleteGroceryMenu.bind(
                                        this
                                    )}
                                >
                                    Delete
